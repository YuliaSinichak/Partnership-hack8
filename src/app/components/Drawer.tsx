                                ...
                                <div className="mt-6 flow-root">
                                    <div className="-my-6 divide-y divide-gray-500/10">
                                        <div className="space-y-2 py-6">
                                            ...
                                            }} className={`${press_start.className} border-2 border-hack-green lg:py-[1.4vw] py-4 px-2 lg:px-[1.6vw] rounded-lg h-fit leading-none lg:w-auto w-full text-hack-green backdrop-blur-sm hover:scale-105 transition-all duration-500 hover:bg-hack-green hover:text-white`}>Стати партнером
                                              </button>
