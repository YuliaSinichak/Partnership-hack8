    ...
    return (
        <section className="min-h-screen w-full flex flex-col mt-32" id="top">
            <div className="flex flex-row items-end ">
                ...
                <Image src='/BubblesHero.svg' height={500} width={500} alt="bubbles" className="lg:absolute top-56 right-0 duration-100  w-xl " />
            ...
            <Image src="/arrow.svg" width={50} height={50} alt="arrow" className="absolute  cursor-pointer animate-bounce w-12 h-12 m-3 self-center bottom-0"
