...
export default function Statistic() {
  return (
    <div className=" flex flex-col w-auto p-36 mx-40 justify-center">
      <h1
        className={` ${press_start.className} flex text-5xl text-hack-green my-12 self-center`}
      >
        Статистика
      </h1>
      <div className="flex flex-row gap-4">
        ...
        <div
          className={`${inter.className} flex items-center flex-col py-20 px-14 border rounded-xl border-hack-green`}
        >
          <h2
            className={`${press_start.className} flex text-hack-green mb-5 text-xl`}
          >
